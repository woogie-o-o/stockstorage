...
const checks = [
  ...
  ["server syntax", "python3", ["-m", "py_compile", "server.py", "scanner_engine.py", "tests/server-log-message-check.py", "tests/server-browser-config-check.py", "tests/server-security-headers-check.py", "tests/server-night-futures-timeout-check.py", "tests/dart-financials-check.py"], { env: pyEnv }],
  ...
  ["server night futures timeout", "python3", ["tests/server-night-futures-timeout-check.py"], { env: pyEnv }],
  ["dart financial parser", "python3", ["tests/dart-financials-check.py"], { env: pyEnv }],
